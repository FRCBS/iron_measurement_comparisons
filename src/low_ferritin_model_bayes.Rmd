...
Version 1: all variables added, also ones we only have for Finnish cohorts.

```{r setup, , message = FALSE}
knitr::opts_chunk$set(echo = TRUE)
# echo "rmarkdown::render('low_ferritin_model_bayes_version1.Rmd', clean=TRUE,output_format='pdf_document',output_file='../results/low_ferritin_model_bayes/low_ferritin_model_bayes_version1.pdf')" | R --slave
library(tidyverse)
library(brms)
library(bayesplot)
```
...
```{r men}
#men
file <- "../results/bmodels/version1/logit_men_b"
...
```{r  pre}
# premenopausal women
file <- "../results/bmodels/version1/logit_pre_b"
...
file <- "../results/bmodels/version1/logit_post_b"
...
regressor_values <- c(
 "Age" = "Age (5 years)",
   ...
   "Smokingyes" ="Smoker",
    ...
    #"RegionHYKS" = "Region (Helsinki university hospital)",
...
All observations are not showing up (two of the regions, one of the cohorts). Both cohorts worked in the original code, what am I missing? Is the effect of the region large enough to account for the variability?

```{r}


ggplot2::ggsave(filename = "../results/figures/low_ferritin_model/version1_forest_all_cohorts_bayes.pdf",
                plot = p,
                width = 35,
                height = 25,
                dpi = 600,
...
This part was not done for version 1.
