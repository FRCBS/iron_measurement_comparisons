...
```{r men}
#men
file <- "../results/bmodels/version2/logit_men_b"
...
```{r  pre}
# premenopausal women
file <- "../results/bmodels/version2/logit_pre_b"
...
file <- "../results/bmodels/version2/logit_post_b"
...
ggplot2::ggsave(filename = "../results/figures/low_ferritin_model/version2_forest_all_cohorts_bayes.pdf",
                plot = p,
                width = 35,
                height = 25,
                dpi = 600,
...
This part was not done for version 2.
