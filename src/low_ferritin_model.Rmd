...
#FINRISK97
older_fr1997 <- fr1997 %>% filter(SUKUP == "Women" & is.na(K129)) %>%  nrow()

fr1997 <- fr1997 %>% 
  mutate(K129 = ifelse(RELEASE_ID %in% older_fr1997, "no_period", as.character(K129))) 

#HEALTH2000
## how was menopause determined?
...
fr1997_summary_final$DaysToPreviousFB <- c("no donation")
####same for h2000

fr1997_summary_final$TwoYearsFromStartCount_FB <- c("no donation")
####same for h2000

# We then  assign a donation interval for 3-6 years for the general population cohorts
fr1997_summary_final %>% mutate(DaysToPreviousFB = runif(nrow(fr1997_summary_final), min = 3*365, max = 6*365) )
####same for h2000 
