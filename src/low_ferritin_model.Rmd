...
#thldalta.rdata contrains all five THL cohorts, get FINRISK97 and Health2000
...
blood_values_init <- indiv_donations_data %>% 
  ...
  dplyr::select(age, Ferritin,Hb_v,CRP,DaysToPreviousFB, MCV, donor) %>% 
  ungroup()
