...
test_smoking <- fr1997_summary_final
test_smoking$Smoking[is.na(test_smoking$Smoking) <- 3]
...
blood_data_summary_final <- blood_data_summary_final %>% 
  dplyr::select(ID, Group, Sex, Age, TwoYearsFromStartCount_FB, DaysToPreviousFB,
                Ferritin, Hb, BMI, Menstruation, Smoking, RedMeat_n, HistoryOfIronSupplements, GivenIronSupplements, IronComplience,
