...
# echo "rmarkdown::render('version2_bayes_ferritin_comparison.Rmd', clean=TRUE,output_format='pdf_document',output_file='../results/bmodels/version1/version2_bayes_ferritin_comparison.pdf')" | R --slave
...
```{r}
# original
ggplot2::ggsave(filename = "../results/figures/model_comparison/version2_bayes_forest_comparison.pdf",
                plot = figure_col,
                width = 65,
                height = 25,
                dpi = 600,
...
ggplot2::ggsave(filename = "../results/figures/model_comparison/version2_bayes_forest_comparison_reversed.pdf",
                plot = figure_col_rev,
                width = 65,
                height = 25,
                dpi = 600,
