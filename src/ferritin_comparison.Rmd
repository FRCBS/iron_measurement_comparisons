...
# echo "rmarkdown::render('version1__subgroup_ferritin_comparison.Rmd', clean=TRUE,output_format='pdf_document',output_file='../results/bmodels_subgroup/ferritin_comparison/version1__subgroup_ferritin_comparison.pdf')" | R --slave
...
```{r}
# original
ggplot2::ggsave(filename = "../results/figures/subgroup_analysis/model_comparison/version1_forest_comparison.pdf",
                plot = figure_col,
                width = 65,
                height = 25,
                dpi = 600,
...
ggplot2::ggsave(filename = "../results/figures/subgroup_analysis/model_comparison/version1_forest_comparison_reversed.pdf",
                plot = figure_col_rev,
                width = 65,
                height = 25,
                dpi = 600,
