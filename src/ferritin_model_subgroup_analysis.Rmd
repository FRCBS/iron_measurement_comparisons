...
```{r blood}
file <- "../results/bmodels_subgroup/version1_ferritin_model_subgroup_analysis/linear_blood_b"
...
```{r  fr1997}
file <- "../results/bmodels_subgroup/version1_ferritin_model_subgroup_analysis/linear_fr1997_b"
...
```{r  h2000}
file <- "../results/bmodels_subgroup/version1_ferritin_model_subgroup_analysis/linear_h2000_b"
...
ggplot2::ggsave(filename = "../results/figures/subgroup_analysis/version1_forest_subgroup_analysis_bayes_ferritin.pdf",
                plot = p,
                width = 35,
                height = 25,
                dpi = 600,
