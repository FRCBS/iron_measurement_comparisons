...
Version 2: includes only variables we have no NA:s for, in order to see if this fixes the issues in version 1. 

```{r setup, , message = FALSE}
knitr::opts_chunk$set(echo = TRUE)
# echo "rmarkdown::render('ferritin_model_bayes_version2.Rmd', clean=TRUE,output_format='pdf_document',output_file='../results/ferritin_model_bayes/ferritin_model_bayes_version2.pdf')" | R --slave
library(tidyverse)
library(brms)
library(bayesplot)
```
...
```{r men}
#men
file <- "../results/bmodels/version2/linear_men_b"
...
```{r  pre}
# premenopausal women
file <- "../results/bmodels/version2/linear_pre_b"
...
file <- "../results/bmodels/version2/linear_post_b"
...
ggplot2::ggsave(filename = "../results/figures/version2_forest_all_cohorts_bayes_ferritin.pdf",
                plot = p,
                width = 35,
                height = 25,
                dpi = 600,
