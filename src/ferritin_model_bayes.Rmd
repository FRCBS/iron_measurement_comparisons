...
# echo "rmarkdown::render('ferritin_model_bayes_version1.Rmd', clean=TRUE,output_format='pdf_document',output_file='../results/ferritin_model_bayes/ferritin_model_bayes_version1.pdf')" | R --slave
library(tidyverse)
library(brms)
library(bayesplot)
```
...
```{r men}
#men
file <- "../results/bmodels/version1/linear_men_b"
...
```{r  pre}
# premenopausal women
file <- "../results/bmodels/version1/linear_pre_b"
...
file <- "../results/bmodels/version1/linear_post_b"
...
ggplot2::ggsave(filename = "../results/figures/version1_forest_all_cohorts_bayes_ferritin.pdf",
                plot = p,
                width = 35,
                height = 25,
                dpi = 600,
...
Same issue as in the low ferritin model, i.e. not all observations are  showing up (two of the regions, one of the cohorts). 
