...
* THIS IS A MODIFIED VERSION OF LOW FERRITIN DATA (https://github.com/FRCBS/iron_measurement_comparisons/blob/master/src/low_ferritin_data.Rmd) AND SHOULD NOT BE USED IN THE IRON MEASUREMENT COMPARISONS PROJECT *
...
h2000$SP2 <- gsub("2", "Women", h2000$SP2)  
 ...
 h2000_summary <- h2000 %>%
    ...
    group_by(RELEASE_ID) %>%
    dplyr::select(IKA2, SP2, FERRITIINI, B_Hb, CRP, RELEASE_ID, BD03, BMII_BMI, FB01, FB02, FB03, FB05, synnytys, BD07, Cohort, MENOP, BD06, MP_2000, BMII_PAINO, BMII_PITUUS) %>%
    ungroup()  
